...
namespace BusinessLogic
{
    public static class DBContext
    {
        ...
        {
            return DBOperations.GetData(CommonMethodsBL.ConnectionString, spName);
        }

        // Get data from db on passed parameters
        public static DataTable GetData(string spName, object[] parameters)
        {
            return DBOperations.GetData(CommonMethodsBL.ConnectionString, spName, parameters);
        }
        ...
        {
            return DBOperations.Save(CommonMethodsBL.ConnectionString, procName, values);
        }
