                        ...
                        <tr>
                            <td colspan="3" style="padding:20px 0 0 0">
                                <asp:Button ID="CancelPushButton" runat="server" CausesValidation="False" CommandName="Cancel"
                                    Text="Cancel" CssClass="btn btn-sm btn-default" meta:resourcekey="CancelPushButtonResource1" />
                                <asp:Button ID="ChangePasswordPushButton" runat="server" CommandName="ChangePassword"
                                    Text="Change Password" CssClass="btn btn-sm btn-primary" meta:resourcekey="ChangePasswordPushButtonResource1" />
                            </td>
                        </tr>
                    </table>
                </ChangePasswordTemplate>
