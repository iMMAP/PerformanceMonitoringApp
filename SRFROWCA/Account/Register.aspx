                                ...
                                <div class="widget-main">
                                    ...
                                    <div id="divOrganization">
                                        ...
                                        <span class="block input-icon input-icon-right">
                                            ...
                                            <a href="../RequestOrganization.aspx" style="font-size: smaller; cursor: pointer;"><asp:Localize ID="localOrgMissin" runat="server" Text="Add organization if you dont see yours in the list." meta:resourcekey="localOrgMissin"></asp:Localize></a>
                                        </span>
