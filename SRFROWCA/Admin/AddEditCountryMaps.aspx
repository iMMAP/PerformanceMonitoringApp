                                                ...
                                                <div class="row">
                                                    <table border="0" style="width: 50%; margin: 10px 10px 10px 20px">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtMapTitleEn" runat="server" CssClass="width-80" MaxLength="500"></asp:TextBox>
                                                                <asp:RequiredFieldValidator runat="server" ID="rfvTitle" ControlToValidate="txtMapTitleEn" ErrorMessage="Required" Display="Dynamic"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtMapTitleFr" runat="server" CssClass="width-80" MaxLength="500"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:CheckBox runat="server" ID="chkIsPublic" Checked="true" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;</td>
