                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                              ...
                                              <tr>
                                                ...
                                                <td class="frmControl">
                                                     <asp:DropDownList ID="ddlPriorityNew" runat="server" AppendDataBoundItems="true" AutoPostBack="true"  Width="300px" OnSelectedIndexChanged="ddlPriorityNew_SelectedIndexChanged">
                                                                    <asp:ListItem Text="Select" Value="-1" Selected="True"></asp:ListItem>
                                                         </asp:DropDownList>
                                                </td>
                                                <td>
                                             ...
                                             <tr>
                                                ...
                                                <td class="frmControl">
                                                     <asp:DropDownList ID="ddlActivityNew" runat="server" AppendDataBoundItems="true"  Width="300px">
                                                                    <asp:ListItem Text="Select" Value="-1" Selected="True"></asp:ListItem>
                                                         </asp:DropDownList>
                                                </td>
                                                <td>
                                             ...
                                             <tr>
                                                ...
                                                <td class="frmControl">
                                                     <asp:DropDownList ID="ddlUnit" runat="server" AppendDataBoundItems="true"  Width="300px">
                                                                    <asp:ListItem Text="Select" Value="-1" Selected="True"></asp:ListItem>
                                                         </asp:DropDownList>
                                                </td>
                                                <td>
