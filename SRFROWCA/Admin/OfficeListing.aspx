<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="OfficeListing.aspx.cs" Inherits="SRFROWCA.Admin.OfficeListing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="buttonsdiv">
        <div class="savebutton">
            <asp:Button ID="btnAddOffice" runat="server" Text="Add New Office" CssClass="button_example" />
        </div>
    ...
    <div class="tablegrid">
        <div style="overflow-x: auto; width: 100%">
            <asp:GridView ID="gvOffice" runat="server" AutoGenerateColumns="false" AllowSorting="True"
                ...
                OnSorting="gvOffice_Sorting" CssClass="imagetable">
