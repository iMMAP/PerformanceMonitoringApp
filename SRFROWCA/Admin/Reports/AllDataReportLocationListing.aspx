<%@ Page Title="SomeTitle" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="AllDataReportLocationListing.aspx.cs" Inherits="SRFROWCA.Admin.Reports.AllDataReportLocationListing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table width="100%">
        ...
        <tr>
            ...
            <td>
                <cc1:DropDownCheckBoxes ID="ddlClusters" runat="server" OnSelectedIndexChanged="ddlClusters_SelectedIndexChanged"
                ...
                <%--<asp:DropDownList ID="ddlClusters" runat="server" CssClass="ddlWidth" AutoPostBack="true"
                    OnSelectedIndexChanged="ddlClusters_SelectedIndexChanged">
                </asp:DropDownList>--%>
            </td>
            <td>
                Objectives:
        ...
        <tr>
            ...
            <td>
                <a id="reportlink" href="http://localhost/SRFROWCA/Handler1.ashx">
