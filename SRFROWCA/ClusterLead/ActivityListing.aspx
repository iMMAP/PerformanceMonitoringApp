<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ActivityListing.aspx.cs" Inherits="SRFROWCA.ClusterLead.ActivityListing" %>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle"   HeaderStyle-Width="80px">
                            <ItemTemplate >
                                <asp:LinkButton ID="btnEdit" runat="server" Text="Edit" Width="80px" CausesValidation="false" 
                                    CommandName="EditActivity" CommandArgument='<%# Eval("ActivityDetailId") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="80px">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnDelete" runat="server" Text="Delete" Width="80px" CausesValidation="false" 
                                    CommandName="Delete" CommandArgument='<%# Eval("ActivityDetailId") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
