                                ...
                                <div class="widget-header widget-header header-color-blue2">
                                    ...
                                    <div class="col-sm-3">
                                        <button id="Button1" runat="server" onserverclick="btnSave_Click" onclick="needToConfirm = false;"
                                            ...
                                            <i class="icon-save"></i><asp:Localize ID="localClsuterTargetsSave" runat="server" Text="Save" meta:resourcekey="localClsuterTargetsSaveResource1"></asp:Localize>
                                        </button>
                                    </div>
                                </div>
                                <div class="widget-body">
...
<ItemStyle Wrap="True" CssClass="testind"></ItemStyle>
                                ...
                                <div>
                                    <button id="btnSave" runat="server" onserverclick="btnSave_Click" onclick="needToConfirm = false;"
                                        ...
                                        <i class="icon-save"></i><asp:Localize ID="localClusterTargetsSave2" runat="server" Text="Save" meta:resourcekey="localClusterTargetsSave2Resource1"></asp:Localize>
                                    </button>
                                </div>
                            </div>
                        </div>
