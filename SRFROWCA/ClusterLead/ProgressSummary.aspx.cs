...
namespace SRFROWCA.ClusterLead
{
    public partial class ProgressSummary : System.Web.UI.Page
    {
        ...
        private DataTable GetSummaryData()
        {
            ...
            return DBContext.GetData("ProgressReportSummary", new object[] { monthId, emgLocationId, emgClusterId, isOPS, year });
        }
        ...
        protected void btnPDFPrint_Click(object sender, EventArgs e)
        {
            ...
            Response.BinaryWrite(WriteDataEntryPDF.GenerateSummaryPDF(dtResults, dtCountryOrgs, month, country, cluster).ToArray());
        }
