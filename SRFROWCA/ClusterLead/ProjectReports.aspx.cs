...
namespace SRFROWCA.ClusterLead
{
    public partial class ProjectReports : BasePage
    {
        ...
        private DataTable GetReports()
        {
            ...
            DataTable dtGrid = DBContext.GetData("uspGetReports", new object[] { projectID, startDate, endDate , null});
        ...
        protected void grdReports_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "PrintReport")
            {
                ...
                DataTable dtResults = DBContext.GetData("uspGetReports", new object[] { Convert.ToString(projectID), null, null, Convert.ToInt32(e.CommandArgument) });
