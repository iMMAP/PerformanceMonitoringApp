...
{
    /// <summary>
    /// Summary description for ClusterIndicatorReports
    /// </summary>
    public class ClusterIndicatorReports : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            DataTable dt = DBContext.GetData("GetClusterReportsFeed", param);
