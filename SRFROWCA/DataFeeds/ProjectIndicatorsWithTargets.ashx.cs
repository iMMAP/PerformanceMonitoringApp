...
{
    /// <summary>
    /// Summary description for ProjectIndicatorsWithTargets
    /// </summary>
    public class ProjectIndicatorsWithTargets : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            DataTable dt = DBContext.GetData("ProjectIndicatorsWithTargets_2016", param);
