<%@ Page Title="ORS Manage Projects" Language="C#" MasterPageFile="~/Ebola/Ebola.Master" AutoEventWireup="true"
    CodeBehind="CreateProject.aspx.cs" Inherits="SRFROWCA.Ebola.CreateProject" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">
                <asp:Localize ID="localBreadCrumbManageProjects" runat="server" Text="Manage Interventions" ></asp:Localize></li>
        </ul>
        <!-- .breadcrumb -->
    </div>
        ...
        <div class="row">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            ...
                            <div class="space"></div>
                            <asp:Button ID="btnCreateProject" runat="server" Text="Create New Intervention" CssClass="btn btn-primary"
            ...
            <div class="col-sm-9 widget-container-span">
                <div class="widget-box">
                    <div class="widget-header widget-header-small header-color-blue2">
                        <h4>
                            <asp:Localize ID="localMangeProjAddEditCaption" runat="server" Text="Add/Edit Intervention" ></asp:Localize>
                        </h4>
                    </div>
                    <div class="widget-body">
                        <div class="widget-main">
                            <table border="0">
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <label>
                                            <asp:Literal ID="ltrlProjectCode" runat="server" ></asp:Literal></label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label>
                                            <asp:Localize ID="localProjectTitle" runat="server" Text="Intervention Title:" ></asp:Localize></label>
                                    </td>
                                    <td colspan="5">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <asp:Localize ID="localProjectObjective" runat="server" Text="Intervention Objective:" ></asp:Localize></label>
                                    </td>
                                    <td colspan="5">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <asp:Localize ID="LocalizeImplementingPartners" runat="server" Text="Intervention Partners:"></asp:Localize></label>
                                    </td>
                                    <td colspan="5">
                                ...
                                <%--<tr>
                                 ...
                                 <tr>
                                    <td>
                                        <label>
                                            <asp:Localize ID="Localize1" runat="server" Text="Intervention Status:"></asp:Localize></label>
                                    </td>
                                    <td colspan="5">
                                        <asp:DropDownList ID="ddlProjectSatus" runat="server" Width="250px">
                                            <asp:ListItem Text="Select Intervention Status" Value="-1"></asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top: 20px;">
                                        <asp:Button ID="btnDeleteProject" runat="server" Text="Delete Project" CssClass="btn btn-danger"
                                            CausesValidation="False" OnClick="btnDeleteProject_Click" OnClientClick="javascript:return confirm('Are you sure your want to delete this intervention?');" meta:resourcekey="btnDeleteProjectResource1" />
                                    </td>
                                </tr>
                            </table>
                        </div>
