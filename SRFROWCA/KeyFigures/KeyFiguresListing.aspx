...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script>
        $(function () {
            $(".imagetable").prepend('<thead><tr style="background-color:ButtonFace;"><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th colspan="3" style="text-align: center;">Total</th><th colspan="3" style="text-align: center;">In Need</th><th colspan="3" style="text-align: center;">Targeted</th> <th>&nbsp;</th> <th>&nbsp;</th><th>&nbsp;</th></tr></thead>');
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-content">
        ...
        <div id="scrolledGridView" style="overflow-x: auto; width: 100%;">
            <asp:GridView ID="gvKeyFigures" runat="server" AutoGenerateColumns="False" OnRowCommand="gvKeyFigures_RowCommand" OnRowDataBound="gvKeyFigures_RowDataBound"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="FromLocation" HeaderText="From Location" SortExpression="FromLocation" ItemStyle-Width="8%"></asp:BoundField>
