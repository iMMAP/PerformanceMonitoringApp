...
{
    public partial class OPSDataEntryOld : BasePage
    {
            ...
            foreach (DataColumn column in dt.Columns)
            {
                        ...
                        columnName == "PriorityActivityId" || columnName == "RInd" || columnName == "CInd" || columnName == "Unit"))
                {
                    if (columnName == "IsAdded")
                    {
                        ...
                        customField.ItemTemplate = new GridViewTemplateOld(DataControlRowType.DataRow, column.ColumnName, "1", "CheckBox");
                        customField.HeaderTemplate = new GridViewTemplateOld(DataControlRowType.Header, "Selected", "1", "CheckBox");
                        gvActivities.Columns.Add(customField);
                    }
                    else
                    {
                        customField.ItemTemplate = new GridViewTemplateOld(DataControlRowType.DataRow, column.ColumnName, "1", "TextBox");
                        customField.HeaderTemplate = new GridViewTemplateOld(DataControlRowType.Header, column.ColumnName, "1", "TextBox");
                        gvActivities.Columns.Add(customField);
                    }
                }
            }
    ...
    public class GridViewTemplateOld : ITemplate
    {
        ...
        public GridViewTemplateOld(DataControlRowType type, string colname, string locId, string cntrlType)
        {
            templateType = type;
            columnName = colname;
            locationId = locId;
