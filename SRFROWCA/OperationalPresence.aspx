<%@ Page Title="ORS - Contact List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="OperationalPresence.aspx.cs" Inherits="SRFROWCA.OperationalPresence" %>
            ...
            <div class="col-xs-12 col-sm-12 widget-container-span">
                <div class="widget-box">
                    <asp:GridView ID="gvPresence" runat="server" AutoGenerateColumns="False" CssClass="imagetable"
                        ...
                        <Columns>
                            <asp:BoundField DataField="Country" HeaderText="Country" ItemStyle-Width="150px" SortExpression="Country" />
