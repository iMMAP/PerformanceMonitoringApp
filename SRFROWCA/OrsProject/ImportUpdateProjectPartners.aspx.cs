...
{
    public partial class ImportUpdateProjectPartners : System.Web.UI.Page
    {
        ...
        private DataTable GetDataFromSheet(string filePath)
        {
            ...
            {
                dt = ReadDataInDataTable(excelConString, "PRJ_IPs$");
        ...
        {
            DBContext.Update("TruncateStagingTablePartners2016", new object[] { DBNull.Value });
        ...
        {
            int yearId = 12;
            return DBContext.Update("ImportProjectPartnersFromStagingTable2016", new object[] { yearId, RC.GetCurrentUserId, DBNull.Value });
        }
        ...
        private void WriteDataToDB(DataTable dt, string conString)
        {
            ...
            sqlBulk.DestinationTableName = "ImportProjectPartnersStaging_Temp";
        ...
        private void RemoveUnwantedColumns(DataTable dt)
        {
            ...
            foreach (DataColumn column in dt.Columns)
            {
                if (!(column.ColumnName == "Id" ||
                    ...
                    column.ColumnName == "IndicatorID" ||
                    column.ColumnName == "project ID" ||
                    column.ColumnName == "LocationID" ||
                    column.ColumnName == "PartnerID"))
                {
                    columns.Add(column);
                }
            }
