<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctlORSAdmin1Report.ascx.cs" Inherits="SRFROWCA.OrsProject.ctlORSAdmin1Report" %>
        ...
        <div id="scrolledGridView" style="overflow-x: auto; width: 100%">
            <asp:GridView ID="gvActivities" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-Width="690" ItemStyle-Width="690">
                        <ItemTemplate>
                                        ...
                                        <tr style="background-color: #C0C0C0">
                                            ...
                                            <td class="tdTable">
                                                <asp:Label ID="lblCountryTargetMaleProject" runat="server"
                                                    Text='<%#Eval("ReportedMale") %>' ToolTip="Achieved: Country Total Male"
                                                    CssClass="trgtCountryGenderMale txtalign" Width="70px"></asp:Label>
                                            </td>
                                            <td class="tdTable">
                                                <asp:Label ID="lblCountryTargetFemaleProject" runat="server"
                                                    Text='<%#Eval("ReportedFemale") %>' ToolTip="Achieved: Country Total Female"
                                                    CssClass="trgtCountryGenderMale txtalign" Width="70px"></asp:Label>
                                            </td>
                                            <td class="tdTable">
                                                <asp:Label ID="lblCountryTargetProject" runat="server"
                                                    Text='<%#Eval("ReportedTotal") %>' ToolTip="Achieved: Country Total"
                                                    CssClass="trgtCountryGenderMale txtalign" Width="70px"></asp:Label>
                                            </td>
                                            <td class="tdTable">
                                                <asp:Label ID="lblCountryRunningValue" runat="server"
                                                    Text='<%#Eval("RunningValue") %>' ToolTip="Achieved: Country Total"
                                                        ...
                                                        <table style="margin: 0 auto; width: 690px;" border="0" class="imagetable imagetable2 tblAdmin1Gender">
                                                            <tr style="background-color: #D8D8D8" class="trAdmin1">
                                                                ...
                                                                <td class="tdTable" style="padding-left: 2px;">
                                                                    <asp:TextBox ID="txtAdmin1ReportedMaleProject" runat="server"
                                                                        Text='<%#Eval("ReportedMale") %>' ToolTip="Achieved Admin1 Total Male"
                                                                        CssClass="trgtAdmin2GenderMale numeric1 padding1 txtalign"
                                                                        Width="70px"></asp:TextBox>
                                                                </td>
                                                                <td class="tdTable" style="padding-left: 2px;">
                                                                    <asp:TextBox ID="txtAdmin1ReportedFemaleProject" runat="server"
                                                                        Text='<%#Eval("ReportedFemale") %>' ToolTip="Achieved Admin1 Total Female"
                                                                        CssClass="trgtAdmin1GenderMale numeric1 padding1 txtalign"
                                                                        Width="70px"></asp:TextBox>
                                                                </td>
                                                                <td class="tdTable" style="padding-left: 2px;">
                                                                    <asp:TextBox ID="txtAdmin1ReportedProject" runat="server"
                                                                        Text='<%#Eval("ReportedTotal") %>' ToolTip="Achieved Admin1 Total"
