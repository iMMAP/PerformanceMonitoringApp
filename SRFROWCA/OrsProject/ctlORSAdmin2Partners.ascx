<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctlORSAdmin2Partners.ascx.cs" Inherits="SRFROWCA.OrsProject.ctlORSAdmin2Partners" %>
                                                                            ...
                                                                            <table style="margin: 0 auto; width: 585px;" border="0" class="imagetable tblAdmin2Gender">
                                                                                <tr>
                                                                                    <td style="width: 130px">
                                                                                        ...
                                                                                        <asp:HiddenField ID="hfAdmin2IndicatorId" runat="server" Value='<%#Eval("IndicatorId")%>' />
                                                                                    </td>
                                                                                    <td class="tdTable">
