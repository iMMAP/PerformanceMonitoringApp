...
{
    public partial class ProjectIP : BasePage
    {
        ...
        private void SelectProjectPartnerOrgs(DropDownCheckBoxes ddlOrgs, int activityId, int locationId)
        {
            ...
            DataTable dt = DBContext.GetData("GetProjectPartners", new object[] { projId, activityId, locationId, 11 });
        ...
        private void PopulateOrganizations(DropDownCheckBoxes ddlOrgs)
        {
            ...
            ddlOrgs.DataSource = DBContext.GetData("GetProjectPartnerOrganizations", new object[] {rblProjects.SelectedValue});
            ddlOrgs.DataBind();
        ...
        private void SavePartners()
        {
            ...
            {
                int projId = RC.GetSelectedIntVal(rblProjects);
                DBContext.Delete("DeleteProjectPartners", new object[] { projId, DBNull.Value });
                SaveProjectPartners(projId);
                scope.Complete();
            }
        }
        ...
        public int LocationRemovedPartner
        {
            get
            {
