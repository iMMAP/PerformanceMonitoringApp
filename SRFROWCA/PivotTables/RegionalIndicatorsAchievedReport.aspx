<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegionalIndicatorsAchievedReport.aspx.cs" Inherits="SRFROWCA.PivotTables.RegionalIndicatorsAchievedReport" %>
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
                                <AjaxSettings>
                                    <telerik:AjaxSetting AjaxControlID="rpgvRegionalIndicatorsAchieved">
                                        <UpdatedControls>
                                            <telerik:AjaxUpdatedControl ControlID="rpgvRegionalIndicatorsAchieved" LoadingPanelID="RadAjaxLoadingPanel1"></telerik:AjaxUpdatedControl>
                                        </UpdatedControls>
                                    </telerik:AjaxSetting>
                                </AjaxSettings>
                            ...
                            <telerik:RadPivotGrid ID="rpgvRegionalIndicatorsAchieved" runat="server" OnNeedDataSource="rpgvRegionalIndicatorsAchieved_NeedDataSource"
                                AllowFiltering="true" AllowPaging="true" PageSize="50" ShowFilterHeaderZone="false"
