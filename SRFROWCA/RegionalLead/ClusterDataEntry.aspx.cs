...
namespace SRFROWCA.RegionalLead
{
    public partial class ClusterDataEntry : BasePage
    {
        ...
        private void DisableDropDowns()
        {
            ...
            //RC.EnableDisableControls(ddlCountry, true);
        }
        ...
        private DataTable GetClusterIndicatros(int? clusterId, int? countryId, string indicator)
        {
            ...
            return DBContext.GetData("uspGetClusterReportDetailsForRegionalLead", new object[] { yearID, monthID, RC.SelectedSiteLanguageId, countryId, clusterId });
        }
        ...
        private void SaveClusterIndicatorDetails()
        {
            ...
            foreach (GridViewRow row in gvIndicators.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    DBContext.Add("uspInsertClusterReportForRegionalLead", new object[] { clusterIndicatorID, clusterId, countryId, yearId, monthId, achieved, RC.GetCurrentUserId, null });
                }
            }
        }
        ...
        protected void btnSaveAll_Click(object sender, EventArgs e)
        {
            ...
            if (country <= 0)
            {
                ShowMessage("Please select Country to save data", RC.NotificationType.Error, true, 4000);
                return;
            }
        ...
        protected void gvIndicators_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                ObjPrToolTip.RegionalIndicatorIcon(e, 13);
