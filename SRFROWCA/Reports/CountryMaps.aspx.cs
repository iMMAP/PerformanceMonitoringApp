    ...
    public partial class CountryMaps : BasePage
    {
            ...
            if (Request.QueryString["cid"] != null)
            {
                using (ORSEntities db = new ORSEntities())
                {
                    ...
                    if ((locationId == 567) || (locationId >= 2 && locationId <= 10))
                    {
                        ...
                        if (location != null)
                        {
                            lblCountryName.Text = location.LocationName + " " + DateTime.Now.Year;
                        }
                    }
                }
            }
        ...
        private DataTable GetReportTypes()
        {
            ...
            if (Request.QueryString["cid"] != null)
            {
                ...
                if (countryId > 0)
                {
                    dt = DBContext.GetData("GetPublicCountryMapTypes", new object[] { countryId, isPublic, RC.SelectedSiteLanguageId });
                }
            }
        ...
        {
            return DBContext.GetData("GetPublicCountryMaps", new object[] { countryId, reportTypeId, RC.SelectedSiteLanguageId });
        }
