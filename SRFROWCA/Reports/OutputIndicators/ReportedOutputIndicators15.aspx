<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportedOutputIndicators15.aspx.cs" Inherits="SRFROWCA.Reports.OutputIndicators.ReportedOutputIndicators15" %>
                ...
                <div class="table-responsive">
                    <div style="overflow-x: auto; width: 100%">
                        <asp:GridView ID="gvClusterReports" Width="100%" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False"
                            AllowSorting="True" AllowPaging="true" AllowCustomPaging="true" PageSize="30"
