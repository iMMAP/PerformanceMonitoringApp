...
namespace SRFROWCA
{
    public partial class UploadSRPLogFrame : System.Web.UI.Page
    {
        ...
        private DataTable ReadDataInDataTable(string excelConString)
        {
            ...
            OleDbCommand cmd = new OleDbCommand(@"Select * from [WASH$]", excelCon);
            excelCon.Open();
        ...
        private void WriteDataToDB(DataTable dt)
        {
            ...
            sqlBulk.DestinationTableName = "StagingSRP";
