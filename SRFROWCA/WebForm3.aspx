<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm3.aspx.cs" Inherits="SRFROWCA.WebForm3" %>
            ...
            Ext.Ajax.request({
                ...
                callback: function (opt, success, response) {
                    ...
                    pcenter.add(new Ext.Panel({
                        id: 'tab_chart' + ranNum,
                        title: 'Chart View [' + panelQueryRecords[0].get('QueryName') + ']',
...
'charts'
            ...
            launch: function () {
                if (Ext.get('loading-mask')) {
                    ...
                    //http://localhost:32701/immap_view_chart.php?rlhidden=false&gridhidden=false&chartdd=NfiDistributions&chartguid={16F692D5-9066-4FD2-BA71-055987F70038}
                }
            }
        });
        Ext.QuickTips.init();
...
<body>
    <div id="loading-mask">
        <img style="position: absolute; width: 128px; height: 128px; left: 50%; top: 40%;
            margin-left: -64px; margin-top: -3px;" src="images/ajax-loader.gif" />
    </div>
</body>
</html>
