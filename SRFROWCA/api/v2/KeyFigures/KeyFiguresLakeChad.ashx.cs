...
{
    /// <summary>
    /// Summary description for KeyFiguresLakeChad
    /// </summary>
    public class KeyFiguresLakeChad : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            DataTable dt = DBContext.GetData("GetKeyFiguresLakeChadFeed", param);
        ...
        private object[] GetReportParam(HttpContext context)
        {
            ...
            {
                subCatIds = context.Request["subcategory"].ToString();
            }
