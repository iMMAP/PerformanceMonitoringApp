<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProjectClusterTargetsAPI.aspx.cs" Inherits="SRFROWCA.api.v2.doc.ProjectClusterTargetsAPI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-content">
        ...
        <table border="0" style="margin: 0 auto; width: 100%;">
            <tr>
                <td>
                    <input type="hidden" id="hdURL" value="http://ors.ocharowca.info/api/v2/Projects/ProjectClusterTargets.ashx?" />
                    <input type="text" id="txtURL" value="hhttp://ors.ocharowca.info/api/v2/Projects/ProjectClusterTargets.ashx?" class="width-100" readonly="readonly" />
                </td>
                <td>
