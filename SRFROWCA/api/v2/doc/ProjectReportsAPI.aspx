<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProjectReportsAPI.aspx.cs" Inherits="SRFROWCA.api.v2.doc.ProjectReportsAPI" %>
    ...
    <script>
        $(function () {
            ...
            $('#btnURL').click(function () {
                ...
                typeQS = MakeSingleValueQueryString("#approved", "appr");
                queryString = MakeURL(queryString, typeQS);

                typeQS = MakeSingleValueQueryString("#selectReportType", "rtype");
                queryString = MakeURL(queryString, typeQS);

                typeQS = MakeSingleValueQueryString("#lcbType", "cp");
                queryString = MakeURL(queryString, typeQS);
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-content">
                                    ...
                                    <div class="row">
                                        <table border="0" style="margin: 0 auto; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label>Approved:</label></td>
                                                <td>
                                                    <select id="approved" class="wdt">
                                                        <option value="all">ALL</option>
                                                        <option value="no">NO</option>
                                                        <option value="yes">YES</option>
                                                    </select>
                                                    <span class='orshelpicon' data-rel='popover' data-placement='bottom' data-original-title='Approved Reported Date' data-content='<b>Yes:</b>Only data whic is approved by Cluster Coordinators<br/><b>No:</b>Only data whic is NOT approved yet<br/><b>All:</b>Returns all reported data'>?</span>
                                                </td>
                                                <td>
                                                    <label>Lang:</label>
                                                </td>
                                                ...
                                                <td>
                                                    <label>Output Type:</label></td>
                                                <td colspan="2">
                                                    <select id="selectReportType" class="wdt">
                                                        <option value="1">Only Reported</option>
                                                    </select>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="selectFormat" style="width: 80px;">
        ...
        <table border="0" style="margin: 0 auto; width: 100%;">
            <tr>
                <td>
                    <input type="hidden" id="hdURL" value="http://localhost:39770/api/v2/Projects/ProjectReports.ashx?" />
                    <input type="text" id="txtURL" value="http://localhost:39770/api/v2/Projects/ProjectReports.ashx?" class="width-100" readonly="readonly" />
                </td>
                <td>
