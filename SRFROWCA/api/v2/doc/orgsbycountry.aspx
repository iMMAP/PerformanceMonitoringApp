<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="orgsbycountry.aspx.cs" Inherits="SRFROWCA.api.v2.doc.orgsbycountry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-content">
        ...
        <table border="0" style="margin: 0 auto; width: 100%;">
            <tr>
                <td>
                    <input type="hidden" id="hdURL" value="http://localhost:39770/api/v2/framework/orgsbycountryapi.ashx?" />
                    <input type="text" id="txtURL" value="http://localhost:39770/api/v2/framework/orgsbycountryapi.ashx?" class="width-100" readonly="readonly" />
                </td>
                <td>
