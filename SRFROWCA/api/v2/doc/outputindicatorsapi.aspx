<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="outputindicatorsapi.aspx.cs" Inherits="SRFROWCA.api.v2.doc.outputindicatorsapi" %>
                                ...
                                <div class="col-xs-12">
                                    <div class="row">
                                        <table border="0" style="margin: 0 auto; width: 100%;">
                                            ...
                                            <tr>
                                                <td>
                                                    <label>Ind Type:</label>
                                                </td>
                                                <td>
                                                    <select id="selectType" class="wdt">
                                                        <option value="both">Regional & Country</option>
                                                        <option value="no">Country</option>
                                                        <option value="yes">Regional</option>
                                                    </select>
                                                </td>
                                                ...
                                                <td colspan="2">
                                                    <select id="selectReportType" class="wdt">
                                                        ...
                                                        <option value="2">Monthly Status</option>
                                                    </select>
