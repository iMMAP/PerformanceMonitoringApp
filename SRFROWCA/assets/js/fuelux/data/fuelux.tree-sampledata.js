...
var tree_data_2 = {
	'pictures' : {name: 'Pictures', type: 'folder', 'fa fa-class':'red'}	,
	'music' : {name: 'Music', type: 'folder', 'fa fa-class':'orange'}	,
	'video' : {name: 'Video', type: 'folder', 'fa fa-class':'blue'}	,
	'documents' : {name: 'Documents', type: 'folder', 'fa fa-class':'green'}	,
...
tree_data_2['pictures']['additionalParameters'] = {
	'children' : {
		'wallpapers' : {name: 'Wallpapers', type: 'folder', 'fa fa-class':'pink'},
		'camera' : {name: 'Camera', type: 'folder', 'fa fa-class':'pink'}
	}
}
