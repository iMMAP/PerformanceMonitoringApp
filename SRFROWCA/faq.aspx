            ...
            <div class="col-xs-12">
                ...
                <div class="tabbable">
                    <ul class="nav nav-tabs padding-18 tab-size-bigger" id="myTab">
                        ...
                        </i><asp:Localize ID="localTab1" runat="server" Text="FAQs" 
                                meta:resourcekey="localTab1Resource1"></asp:Localize> </a></li>
                        <li><a data-toggle="tab" href="#faq-tab-2"><i class="green icon-user bigger-120"></i>
                            <asp:Localize ID="localTab2" runat="server" Text="Help" meta:resourcekey="localTab2Resource1" 
                                ></asp:Localize>
                        </a></li>
                        <li><a data-toggle="tab" href="#faq-tab-4"><i class="grey icon-facetime-video bigger-120">
                    ...
                    <div class="tab-content no-border padding-24">
                        <div id="faq-tab-1" class="tab-pane fade in active">
                            <h4 class="blue">
                                <i class="icon-ok bigger-110"></i><asp:Localize ID="localTab1Heading" 
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-1-1" data-parent="#faq-list-1" data-toggle="collapse" class="accordion-toggle collapsed">
                                            ...
                                            </i><i class="icon-user bigger-130"></i>&nbsp;
                                            <asp:Localize ID="localGeneralQ1" runat="server" Text="What is ORS?" meta:resourcekey="localGeneralQ1Resource1" 
                                            ></asp:Localize></a>
                                    </div>
                                    ...
                                    <div class="panel-collapse collapse" id="faq-1-6">
                                        <div class="panel-body">
                                            <asp:Localize ID="localGeneralAns6" runat="server" 
                                                ...
                                                Text="You need to register online at http://ors.ocharowca.info/ Download the User Guide and follow the instructions." meta:resourcekey="localGeneralAns6Resource1" 
                                                ></asp:Localize>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-1-2" data-parent="#faq-list-1" data-toggle="collapse" class="accordion-toggle collapsed">
                                            <i class="icon-chevron-left pull-right" data-icon-hide="icon-chevron-down" data-icon-show="icon-chevron-left">
                                            </i><i class="icon-sort-by-attributes-alt"></i>&nbsp;
                                            <asp:Localize ID="localGeneralQ2" runat="server" Text="Who can access ORS?" meta:resourcekey="localGeneralQ2Resource1" 
                                            ></asp:Localize></a>
                                    </div>
                                    <div class="panel-collapse collapse" id="faq-1-2">
                                        <div class="panel-body">
                                            <asp:Localize ID="localGeneralAns2" runat="server" 
                                                ...
                                                Text="<p>ORS is accessible to all humanitarian stakeholders including UN agencies and NGOs, donors , and national government agencies. Summarized Performance monitoring data is public and accessible to all , while detailed reports and other functionalities are accessible after registering to the database To access ORS go to: http://ors.ocharowca.info/ </p>" meta:resourcekey="localGeneralAns2Resource1" 
                                                ></asp:Localize>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-1-3" data-parent="#faq-list-1" data-toggle="collapse" class="accordion-toggle collapsed">
                                            <i class="icon-chevron-left pull-right" data-icon-hide="icon-chevron-down" data-icon-show="icon-chevron-left">
                                            </i><i class="icon-credit-card bigger-130"></i>&nbsp;
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-1-4" data-parent="#faq-list-1" data-toggle="collapse" class="accordion-toggle collapsed">
                                            ...
                                            Text="How to select your role in ORS" meta:resourcekey="localGeneralQ4Resource1" 
                                            ></asp:Localize>
                                        </a>
                                    </div>
                                                    ...
                                                    <div class="panel-collapse collapse" id="faq-list-1-sub-1">
                                                        <div class="panel-body">
                                                            <asp:Localize ID="localGeneraolAns1p1" runat="server" 
                                                                ...
                                                                Text="<p>You belong to an appealing organization (United Nations or NGO) based in the field and you want to report on ORS. You can view all projects entered by your organization and submit achievements on them.</p>" meta:resourcekey="localGeneraolAns1p1Resource1" 
                                                                ></asp:Localize>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="panel-collapse collapse" id="faq-list-1-sub-3">
                                                        <div class="panel-body">
                                                            <asp:Localize ID="localGeneraolAns1p3" runat="server" 
                                                                ...
                                                                Text="<p>You belong to an appealing organization (United Nations or NGO) based in the field, and you have the function of Regional Cluster Lead.</p> <p>You have rights to submit reporting, select regional indicators, and generate custom reports.</p>" meta:resourcekey="localGeneraolAns1p3Resource1" 
                                                                ></asp:Localize>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <a href="#faq-list-1-sub-4" data-parent="#faq-list-nested-1" data-toggle="collapse"
                                                            class="accordion-toggle collapsed"><i class="icon-plus smaller-80 middle" data-icon-hide="icon-minus"
                                                                data-icon-show="icon-plus"></i>&nbsp;
                                                            <asp:Localize ID="localGeneralQ1p4" runat="server" Text="OCHA Field Staff" meta:resourcekey="localGeneralQ1p4Resource1" 
                                                            ></asp:Localize>
                                                        </a>
                                                    </div>
                                                    <div class="panel-collapse collapse" id="faq-list-1-sub-4">
                                                        <div class="panel-body">
                                                            <asp:Localize ID="localGeneraolAns1p4" runat="server" 
                                                                ...
                                                                Text="<p>You are the database administrator at field level. You can view and edit all data, upload achievements on behalf of other organizations and approve/reject/restore achievements on behalf of the Cluster Lead.</p>" meta:resourcekey="localGeneraolAns1p4Resource1" 
                                                                ></asp:Localize>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="panel-collapse collapse" id="faq-1-5">
                                        <div class="panel-body">
                                            <asp:Localize ID="localGeneralAns5" runat="server" 
                                                ...
                                                Text="<p>ORS provides the user with an option to choose French or English language. To change the Language preference simply click on your choice on the top right part of the window.</p>" meta:resourcekey="localGeneralAns5Resource1" 
                                                ></asp:Localize>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-1-7" data-parent="#faq-list-1" data-toggle="collapse" class="accordion-toggle collapsed">
                                            ...
                                            Text="I forgot my password, do I need to-register again?" meta:resourcekey="localGeneralQ7Resource1" 
                                            ></asp:Localize></a>
                                    </div>
                                    <div class="panel-collapse collapse" id="faq-1-7">
                                        <div class="panel-body">
                                            <asp:Localize ID="localGeneralAns7" runat="server" 
                                                ...
                                                Text="Go to ORS, click on <b>Log on</b> and select <b>“I forgot my password”</b> link next to the password box on the log in page." meta:resourcekey="localGeneralAns7Resource1" 
                                                ></asp:Localize>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-1-8" data-parent="#faq-list-1" data-toggle="collapse" class="accordion-toggle collapsed">
                                            ...
                                            Text="I cannot find my organization in the organizations list" meta:resourcekey="localGeneralQ8Resource1" 
                                            ></asp:Localize></a>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-1-9" data-parent="#faq-list-1" data-toggle="collapse" class="accordion-toggle collapsed">
                                            ...
                                            Text="I filled the form providing information about my organization but cannot access the database." meta:resourcekey="localGeneralQ9Resource1" 
                                            ></asp:Localize></a>
                                    </div>
                                    <div class="panel-collapse collapse" id="faq-1-9">
                                        <div class="panel-body">
                                            <asp:Localize ID="localGeneralAns9" runat="server" 
                                                ...
                                                Text="You have filled out the form, but that is not the same as completing the registration. You need to wait until you get an e-mail confirming that your organization has been uploaded in the organization list before proceeding with the on-line registration process." meta:resourcekey="localGeneralAns9Resource1" 
                                                ></asp:Localize>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-1-10" data-parent="#faq-list-1" data-toggle="collapse" class="accordion-toggle collapsed">
                                            ...
                                            Text="Who can register in ORS from my organization?" meta:resourcekey="localGeneralQ10Resource1" 
                                            ></asp:Localize></a>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-1-11" data-parent="#faq-list-1" data-toggle="collapse" class="accordion-toggle collapsed">
                                            ...
                                            Text="How many times can we report?" meta:resourcekey="localGeneralQ11Resource1" 
                                            ></asp:Localize></a>
                                    </div>
                                    <div class="panel-collapse collapse" id="faq-1-11">
                                        <div class="panel-body">
                                            <asp:Localize ID="localGeneralAns11" runat="server" 
                                                Text="You can report as many times as possible per month." meta:resourcekey="localGeneralAns11Resource1" 
                                                ></asp:Localize>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-1-12" data-parent="#faq-list-1" data-toggle="collapse" class="accordion-toggle collapsed">
                                            ...
                                            Text="HHow do I know that my data has been approved?" meta:resourcekey="localGeneralQ12Resource1" 
                                            ></asp:Localize></a>
                                    </div>
                                    <div class="panel-collapse collapse" id="faq-1-12">
                                        <div class="panel-body">
                                            <asp:Localize ID="localGeneralAns12" runat="server" 
                                                ...
                                                Text="You will be notified when you submit data and when the Cluster Coordinator approves the data." meta:resourcekey="localGeneralAns12Resource1" 
                                                ></asp:Localize>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="faq-tab-2" class="tab-pane fade">
                            <h4 class="blue">
                                <i class="green icon-user bigger-110"></i><asp:Localize ID="localTab2Heading" 
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-2-1" data-parent="#faq-list-2" data-toggle="collapse" class="accordion-toggle collapsed">
                                            ...
                                            <asp:Localize ID="localHelpQ1" runat="server" Text="Registration" meta:resourcekey="localHelpQ1Resource1" 
                                            ></asp:Localize></a>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-2-2" data-parent="#faq-list-2" data-toggle="collapse" class="accordion-toggle collapsed">
                                            ...
                                            Text="How to select language English/French" meta:resourcekey="localHelpQ2Resource1" 
                                            ></asp:Localize>
                                        </a>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-2-4" data-parent="#faq-list-2" data-toggle="collapse" class="accordion-toggle collapsed">
                                            <i class="icon-chevron-right smaller-80" data-icon-hide="icon-chevron-down align-top"
                                                data-icon-show="icon-chevron-right"></i>&nbsp;
                                            <asp:Localize ID="localHelpQ4" runat="server" Text="How to Report On ORS" meta:resourcekey="localHelpQ4Resource1" 
                                            ></asp:Localize>
                                        </a>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-2-5" data-parent="#faq-list-2" data-toggle="collapse" class="accordion-toggle collapsed">
                                            <i class="icon-chevron-right smaller-80" data-icon-hide="icon-chevron-down align-top"
                                                data-icon-show="icon-chevron-right"></i>&nbsp;
                                            <asp:Localize ID="localHelpQ5" runat="server" Text="Reports IN ORS" meta:resourcekey="localHelpQ5Resource1" 
                                            ></asp:Localize>
                                        </a>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <a href="#faq-2-6" data-parent="#faq-list-2" data-toggle="collapse" class="accordion-toggle collapsed">
                                            <i class="icon-chevron-right smaller-80" data-icon-hide="icon-chevron-down align-top"
                                                data-icon-show="icon-chevron-right"></i>&nbsp;
                                            <asp:Localize ID="localHelpQ6" runat="server" Text="Cluster Lead Role" meta:resourcekey="localHelpQ6Resource1" 
                                            ></asp:Localize>
                                        </a>
                                    </div>
                                    ...
                                    <div class="panel-collapse collapse" id="faq-4-1">
                                        <div class="panel-body">
                                            <div id="faq-list-nested-4" class="panel-group accordion-style1 accordion-style2">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <a href="#faq-list-4-sub-1" data-parent="#faq-list-nested-4" data-toggle="collapse"
                                                            class="accordion-toggle collapsed"><i class="icon-plus smaller-80 middle" data-icon-hide="icon-minus"
                                                                data-icon-show="icon-plus"></i>&nbsp;Register
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <a href="#faq-list-4-sub-4" data-parent="#faq-list-nested-4" data-toggle="collapse"
                                                            class="accordion-toggle collapsed"><i class="icon-plus smaller-80 middle" data-icon-hide="icon-minus"
                                                                data-icon-show="icon-plus"></i>&nbsp;
                                                            OCHA Field Staff
                                                        </a>
                                                    </div>
                                                    <div class="panel-collapse collapse" id="faq-list-4-sub-4">
                                                        <div class="panel-body">
                                                            <div>
                                                                <a href="https://www.youtube.com/watch?v=QK3Molj9wtg&list=PLlXl6B0m9IO1_-IZLhCD4cRr1Ma2H4DVX"
                                                                    target="_blank">Watch on youtube</a>
                                                            </div>
                                                            <div>
                                                                <iframe width="640" height="360" src="//www.youtube.com/embed/QK3Molj9wtg?list=PLlXl6B0m9IO1_-IZLhCD4cRr1Ma2H4DVX"
                                                                    frameborder="0" allowfullscreen></iframe>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="panel-collapse collapse" id="faq-42">
                                        <div class="panel-body">
                                            <div id="faq-list-nested-42" class="panel-group accordion-style1 accordion-style2">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <a href="#faq-list-42-sub-4" data-parent="#faq-list-nested-42" data-toggle="collapse"
                                                            class="accordion-toggle collapsed"><i class="icon-plus smaller-80 middle" data-icon-hide="icon-minus"
                                                                data-icon-show="icon-plus"></i>&nbsp;
                                                            OCHA Field Staff
                                                        </a>
                                                    </div>
                                                    <div class="panel-collapse collapse" id="faq-list-42-sub-4">
                                                        <div class="panel-body">
                                                            <div>
                                                                <a href="https://www.youtube.com/watch?v=QK3Molj9wtg&list=PLlXl6B0m9IO1_-IZLhCD4cRr1Ma2H4DVX"
                                                                    target="_blank">Watch on youtube</a>
